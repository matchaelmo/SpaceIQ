const features = [
  {
    ...
    description: 'Identify offices, meeting rooms, collaboration zones, and circulation areas from uploaded plans.',
    icon: '▣'
  },
  {
    title: 'Asset Planning',
    description: 'Map desks, equipment, neighborhoods, and shared resources before teams move in.',
    icon: '◈'
  },
  {
    title: 'Wayfinding Maps',
    description: 'Generate clean, navigable workplace maps that help people find rooms and amenities faster.',
    icon: '⌖'
  },
  {
    title: 'Project Tracking',
    description: 'Coordinate relocation milestones, space readiness, and workplace changes in one command center.',
    icon: '✓'
  }
];
